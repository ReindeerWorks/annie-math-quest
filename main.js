...
(function () {
  ...
  var SUCCESS_HAYDEN = [
    "Amazing Annie!",
    "You got it Annie!",
    "Annie you're a math hero!",
    "Incredible Annie!",
    "Annie that's right!",
    "Woohoo Annie!",
    "Annie you're unstoppable!",
    "Yes Annie, you're a genius!",
  ];
  ...
  function handleAnswer(chosen, p, btn, answersRow) {
    ...
    if (chosen === p.answer) {
      ...
      var msg = (p.type === 1)
        ? "That's right, it was " + p.number + "! Great job Annie!"
        : pickSuccessMsg();
  ...
  function finishLevel() {
    ...
    msg.innerHTML = "You did it Annie!<br>You're a demon hunter hero!";
    box.appendChild(msg);
    ...
    speak("You did it Annie! You're a demon hunter hero!");
  }
